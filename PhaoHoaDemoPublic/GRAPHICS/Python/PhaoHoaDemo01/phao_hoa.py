...
class PhaoHoa:
    def __init__(self):
        ...
        hatBan_vantoc = Point(0, -10)
        hatBan_thoigiansong = randint(20, 40)
        hatBan_mausac = "white"

        self.hatBan = Hat(hatBan_toado, hatBan_vantoc, hatBan_thoigiansong, hatBan_mausac)
        self.listHat = []
    ...
    def PhatNo(self):
        n = randint(40, 80)
        self.listHat = []
        mausac = choice(Global.ListColors)
        ...
        for i in range(n):
            ...
            hat = Hat(self.hatBan.ToaDo, vantoc, thoigiansong, mausac)
