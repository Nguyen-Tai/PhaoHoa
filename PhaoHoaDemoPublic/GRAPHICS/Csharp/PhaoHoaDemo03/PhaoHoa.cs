...
namespace PhaoHoaDemo03
{
    ...
    class PhaoHoa
    {
        ...
        public PhaoHoa(Graphics g)
        {
            ...
            PointF hatBan_vantoc = new PointF(0, -12);
            int hatBan_thoigiansong = ra.Next(25, 50);

            hatBan = new HatBan(hatBan_toado, hatBan_vantoc, hatBan_thoigiansong, Brushes.Red);
        }
        ...
        void PhatNo()
        {
            int n = ra.Next(60, 100);
            listHat = new List<Hat>(n);

            // cọ vẽ chung
            Brush coVeChung = Global.DsCoVe[ra.Next(Global.DsCoVe.Length)].Clone() as Brush;
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                int thoigiansong = ra.Next(20, Hat.ThoiGianSongMax);
